'use server';
/**
 * @fileOverview A flow for generating poems based on a theme and style.
 *
...
const GeneratePoemInputSchema = z.object({
  ...
  style: z.string().describe('The poetry style for the poem.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a world-class poet. Your task is to compose a beautiful poem.

You must write the poem based on the following theme: {{{theme}}}
The poem must be in the following style: {{{style}}}

The poem should be evocative, creative, and follow the conventions of the requested style.
`,
});
